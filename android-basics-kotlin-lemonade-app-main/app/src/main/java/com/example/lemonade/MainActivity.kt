...
class MainActivity : AppCompatActivity() {
	...
	private fun setViewElements() {
		...
		val (drawableResource, textResource) = when (lemonadeState) {
			SELECT -> {
				Pair(
					R.drawable.lemon_tree,
					getString(R.string.lemon_select)
				)
			}
			SQUEEZE -> {
				Pair(
					R.drawable.lemon_squeeze,
					getString(R.string.lemon_squeeze)
				)
			}
			DRINK -> {
				Pair(
					R.drawable.lemon_drink,
					getString(R.string.lemon_drink)
				)
			}
			else -> {
				Pair(
					R.drawable.lemon_restart,
					getString(R.string.lemon_empty_glass)
				)
			}
		}
